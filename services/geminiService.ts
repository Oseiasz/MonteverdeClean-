...
export const getCleaningTip = async (): Promise<string> => {
  try {
    // Acesso seguro ao process.env para evitar ReferenceError em navegadores
    ...
    return "Mantenha as áreas comuns limpas: o bem-estar de todos depende da colaboração de cada um.";
  }
};
